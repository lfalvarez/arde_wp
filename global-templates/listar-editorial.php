...
<div class="listado-editorial <?php echo esc_attr( $container ); ?> pb-5">
        <div class='row titulo-colecciones-home'>
            <div class="col-12">
                <div class="text-center text-uppercase titulo">Blog</div>
                <p class="bajada-titulos-inicio mx-auto gt-america text-center">Noticias, columnas, entrevistas y reportajes sobre archivos, artistas y sus documentos, arte y comunidad.</p>
            </div>
        </div>
...
<?php endwhile;?>
                 ...
                 <div class="ir-a-seccion col-md-12 border-0 text-right small"><a href="https://proyectoarde.org/editorial/">Ir a todos los contenidos del blog &gt;</a></div>
