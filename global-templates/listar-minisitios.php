...
<div class="listado-galerias <?php echo esc_attr( $container ); ?>">
        <div class='row titulo-colecciones-home'>
            <div class="col-12">
                ...
                <p class="mx-auto bajada-titulos-inicio gt-america text-center" style="font-size: 50%;">Muestras del archivo, o minisitios, que almacenan una exposición digital de un artista, grupo o tema.</p>
            </div>
        </div>
