...
<head>
    ...
    <meta property="og:image" content="<?php bloginfo('template_url'); ?>/images/proyecto-arde-redes-sociales.png" />
    ...
    <meta name="twitter:image" content="<?php bloginfo('template_url'); ?>/img/proyecto-arde-redes-sociales.png">
